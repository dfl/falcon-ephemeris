...
import Ephemeris, { obliquity as trueObliquity, apparentSiderealTime } from '../../../src/ephemeris-mit.js';
...
export class Horoscope {
  ...
  createAscendant() {
    const decimalDegrees = applyZodiacOffsetCounter(
      getAscendant({
        latitude: this.origin.latitude, obliquityEcliptic: this._trueObliquity,
